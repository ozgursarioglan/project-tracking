...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { email: @option.email, home: @option.home, name: @option.name, url: @option.url } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { email: @option.email, home: @option.home, name: @option.name, url: @option.url } }
